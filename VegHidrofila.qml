...
<qgis simplifyDrawingHints="1" minScale="1e+8" simplifyLocal="1" simplifyMaxScale="1" version="3.2.2-Bonn" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0">
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{7e5238c9-fcff-4a5e-934d-075ed184c280}">
      <rule symbol="0" scalemindenom="25000" label="Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral" key="{e0a3df3e-41f3-4096-bdd6-f012c3b1fc8e}" scalemaxdenom="500000" filter="&quot;tipo&quot; = 'Pajonal, Malezal, Cardal, Cortaderal, Españal, Jarillal, Quiscal, Juncal, Totoral'"/>
      <rule symbol="1" key="{ce22f6de-6f47-4573-b219-7f8f0d5a3756}" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol name="0" type="fill" alpha="1" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SVGFill" pass="0">
          <prop v="0" k="angle"/>
          <prop v="70,99,203,255" k="color"/>
          ...
          <prop v="/home/user/Desktop/simbologia/SVGs/pastito 2.0.svg" k="svgFile"/>
      ...
      <symbol name="1" type="fill" alpha="1" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          ...
          <prop v="228,206,126,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <aliases>
    ...
    <alias name="" field="opeador" index="5"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="opeador"/>
  ...
  <constraints>
    ...
    <constraint field="opeador" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="opeador" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="opeador" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="opeador" labelOnTop="0"/>
