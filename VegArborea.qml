...
<qgis simplifyDrawingHints="1" minScale="1e+8" simplifyLocal="1" simplifyMaxScale="1" version="3.2.2-Bonn" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0">
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{05e7316a-a3f1-475d-8e1e-06cd7e6d2a82}">
      <rule symbol="0" scalemindenom="25000" label="Bosque Artificial" key="{08b6d833-17bc-4cfb-9541-5550f090bfc6}" scalemaxdenom="249999" filter="&quot;tipo&quot; = 'Bosque Artificial'"/>
      <rule symbol="1" scalemindenom="25000" label="Bosque, Selva, Foresta o Parque Natural Bajo" key="{24a05e8f-9d75-4367-8d25-34034e55c28d}" scalemaxdenom="500000" filter="&quot;tipo&quot; = 'Bosque, Selva, Foresta o Parque Natural Bajo'"/>
      <rule symbol="2" scalemindenom="25000" label="Coniferas" key="{0769db8d-3de0-412a-b542-f403baebe3ce}" scalemaxdenom="500000" filter="&quot;tipo&quot; = 'Coniferas'"/>
      <rule symbol="3" scalemindenom="25000" label="Palmar" key="{7ed3e147-3fe9-490e-b0da-617d8f6a3bb1}" scalemaxdenom="500000" filter="&quot;tipo&quot; = 'Palmar'"/>
      <rule symbol="4" key="{22ca7109-e5eb-46c7-af99-e7781a5ea6ed}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol name="1" type="fill" alpha="1" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SVGFill" pass="0">
          ...
          <prop v="/home/user/Desktop/simbologia/SVGs/bosqueArtificial.svg" k="svgFile"/>
      ...
      <symbol name="2" type="fill" alpha="1" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SVGFill" pass="0">
          <prop v="0" k="angle"/>
          <prop v="209,106,142,255" k="color"/>
          <prop v="35,35,35,255" k="outline_color"/>
          ...
          <prop v="3x:0,0,0,0,0,0" k="pattern_width_map_unit_scale"/>
          <prop v="MM" k="pattern_width_unit"/>
          <prop v="/home/user/Desktop/simbologia/SVGs/coniferas.svg" k="svgFile"/>
          <prop v="3x:0,0,0,0,0,0" k="svg_outline_width_map_unit_scale"/>
          <prop v="MM" k="svg_outline_width_unit"/>
          <prop v="5.2" k="width"/>
          <data_defined_properties>
          ...
          <symbol name="@2@0" type="line" alpha="1" clip_to_extent="1">
            <layer enabled="1" locked="0" class="SimpleLine" pass="0">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
      ...
      <symbol name="3" type="fill" alpha="1" clip_to_extent="1">
        <layer enabled="1" locked="0" class="SVGFill" pass="0">
          ...
          <prop v="3x:0,0,0,0,0,0" k="pattern_width_map_unit_scale"/>
          <prop v="MM" k="pattern_width_unit"/>
          <prop v="/home/user/Desktop/simbologia/SVGs/palmar.svg" k="svgFile"/>
          <prop v="3x:0,0,0,0,0,0" k="svg_outline_width_map_unit_scale"/>
          <prop v="MM" k="svg_outline_width_unit"/>
          <prop v="20" k="width"/>
          <data_defined_properties>
          ...
          <symbol name="@3@0" type="line" alpha="1" clip_to_extent="1">
            <layer enabled="1" locked="0" class="SimpleLine" pass="0">
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
              <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
  ...
  <aliases>
    ...
    <alias name="" field="tipo" index="1"/>
    <alias name="" field="escala" index="2"/>
    <alias name="" field="signo" index="3"/>
    <alias name="" field="fuente" index="4"/>
    <alias name="" field="operador" index="5"/>
    <alias name="" field="dataset" index="6"/>
    <alias name="" field="fclass" index="7"/>
    <alias name="" field="responsabl" index="8"/>
    <alias name="" field="cargo" index="9"/>
    <alias name="" field="progreso" index="10"/>
    <alias name="" field="t_act" index="11"/>
    <alias name="" field="coord" index="12"/>
    <alias name="" field="sp" index="13"/>
    <alias name="" field="datum" index="14"/>
    <alias name="" field="ac" index="15"/>
    <alias name="" field="detalle" index="16"/>
    <alias name="" field="actualizac" index="17"/>
    <alias name="" field="igds_style" index="18"/>
    <alias name="" field="igds_type" index="19"/>
    <alias name="" field="igds_weigh" index="20"/>
    <alias name="" field="rotation" index="21"/>
    <alias name="" field="igds_color" index="22"/>
    <alias name="" field="group" index="23"/>
    <alias name="" field="igds_level" index="24"/>
    <alias name="" field="length" index="25"/>
    <alias name="" field="shape_area" index="26"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="detalle"/>
  ...
  <constraints>
    ...
    <constraint field="detalle" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="detalle" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="detalle" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="detalle" labelOnTop="0"/>
